...
<template>
  <div class="TeamPage">
    <TeamHero>
      ...
      <template #lead
        >The development of Multipass and its ecosystem is guided by an international
    ...
    <TeamList :members="membersCoreData as Member[]">
      ...
      <template #lead
        >Core team members are those who are actively involved. They have made significant
        contributions to the Multipass ecosystem, with a long term commitment to the
...
<!--      <template #lead-->
<!--        >Some members of the Multipass community have so enriched it, that they-->
